...
if __name__ == '__main__':
    mol = gto.Mole()
    mol.atom = '''
    N	0.0000000	0.0000000	0.1166360
    H	0.0000000	0.9347540	-0.2721510
    H	0.8095200	-0.4673770	-0.2721510
    H	-0.8095200	-0.4673770	-0.2721510
    '''
    mol.basis = 'ccpvtz'
    mol.verbose = 7
    ...
    # Save df to file
    df.to_csv('ammonia_eom_data.csv', index=False)
    ...
    ax.legend()
    fig.savefig('ammonia_ip_excitation_energy.png')
    ...
    ax.legend()
    fig.savefig('ammonia_ea_excitation_energy.png')
    ...
    ax.legend()
    fig.savefig('ammonia_ip_ea_excitation_energy.png')
