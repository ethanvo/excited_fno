...
if __name__ == '__main__':
    ...
    H	0.6280510	0.6280510	0.6280510
    H	-0.6280510	-0.6280510	0.6280510
    H	-0.6280510	0.6280510	-0.6280510
    H	0.6280510	-0.6280510	-0.6280510
    '''
    ...
    # Save df to file
    df.to_csv('methane_eom_data.csv', index=False)
    ...
    ax.legend()
    fig.savefig('methae_ip_excitation_energy.png')
    ...
    ax.legend()
    fig.savefig('methane_ea_excitation_energy.png')
    ...
    ax.legend()
    fig.savefig('methane_ip_ea_excitation_energy.png')
